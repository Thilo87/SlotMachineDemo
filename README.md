A simple slot machine project made with UE5. Contains all the base classes needed for making more complex slot machines and one exemplary graphical slot machine.
